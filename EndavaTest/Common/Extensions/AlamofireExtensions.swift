...
extension DataRequest {
  ...
  @discardableResult func responseObject<T: Unboxable>(keyPath: String? = nil,
                                         options: JSONSerialization.ReadingOptions = .allowFragments,
                                         completionHandler: @escaping (Result<T, NetworkError>, DataResponse<Any>) -> Void) -> Self {
    return debugLog()
      .validate()
  ...
  @discardableResult func responseArray<T: Unboxable>(keyPath: String? = nil,
                                        options: JSONSerialization.ReadingOptions = .allowFragments,
                                        completionHandler: @escaping (Result<[T], NetworkError>, DataResponse<Any>) -> Void) -> Self {
    return debugLog()
      .validate()
